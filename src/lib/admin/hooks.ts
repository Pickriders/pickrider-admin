...
import { achievements, admin, adminLogs, businesses, coupons, deliveryPrice, finance, issues, me, messaging, orders, settings, stats, transactions, users, vehicles, type Query, type RangeQuery } from "./api";
