...
import { columns } from "../../more-orders/Tables/Columns";
...
export const DataTable = ({ type, orderNumber }: DataTableProps) => {
  const query = React.useMemo(() => ({ limit: LIMIT, type, orderNumber }), [type, orderNumber]);
