      ...
      <div className="rounded-lg bg-[#DEF4F2] py-4 flex-1 px-4 h-[130px]">
        <div>
          ...
          <div className="flex mt-2 items-center gap-x-5">
            ...
            <span className="font-semibold font-clash-display  dark:text-stone-950 text-2xl">$0</span>
          </div>
        </div>
      </div>
      <div className="rounded-lg bg-[#FF52441F] flex-1 py-4 px-4 h-[130px]">
        <div>
          <span className="font-montserrat text-sm text-primary-gray font-semibold">Total Expenditure</span>
          <div className="flex mt-2 items-center gap-x-5">
            <div className="h-[2.1rem] w-[4px] rounded-2xl bg-[#FF5244]" />
            <span className="font-semibold font-clash-display text-2xl">$0</span>
          </div>
        </div>
      </div>
    </div>
