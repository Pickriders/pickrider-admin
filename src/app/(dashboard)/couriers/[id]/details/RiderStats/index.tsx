...
export const RidersStats = ({ phoneNumber }: IRidersStats) => {
  return (
    <div>
      ...
      <div className="mt-5  grid grid-cols-2 gap-x-14 gap-y-8 w-[19rem] ">
        <div className="space-y-2">
          ...
          <p className="font-semibold text-primary-purple text-xs">+{phoneNumber}</p>
        </div>
        ...
        <div className="space-y-2">
          <h4 className="font-semibold text-primary-gray text-xs">Average Rating</h4>
          <p className="font-semibold text-primary-purple text-xs">4.2</p>
        </div>
        <div className="space-y-2">
          <h4 className="font-semibold text-primary-gray text-xs">Total Reviews</h4>
