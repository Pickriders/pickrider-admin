...
export default function AuthLayout({
  ...
  return (
    <div className="flex min-h-screen items-center px-2.5 py-4 sm:p-6">
      <div className="relative hidden h-[calc(100vh-3rem)] w-[34rem] shrink-0 overflow-hidden rounded-3xl bg-gradient-to-br from-[#1E1F1F] via-[#2E1030] to-[#3FA49F] p-9 text-white lg:flex lg:flex-col">
        <div className="flex items-center gap-2">
          <SVG.PickridersLogo className="h-[3.6rem] w-auto fill-white stroke-white" />
        </div>
      ...
      <div className="z-40 mx-auto w-full max-w-[32rem] px-1">{children}</div>
    </div>
  );
}
